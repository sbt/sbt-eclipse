...
* #21: Duplicate project dependency in Eclipse if normal and test dependency
* #20: Multi-module library dependencies support broken
* #10: Pretty print Eclipse XML files
* #19: Added option for same target directory
