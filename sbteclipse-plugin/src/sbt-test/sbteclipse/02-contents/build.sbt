...
TaskKey[Unit]("verify-classpath-xml-root") <<= baseDirectory map { dir =>
  ...
  if (!(classpath.child contains <classpathentry kind="src" path="src/test/java" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="src/test/java" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/main/resources" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="src/main/resources" output="target/scala-2.10/classes" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/test/resources" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="src/test/resources" output="target/scala-2.10/test-classes" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="target/scala-2.10/src_managed/main" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="target/scala-2.10/src_managed/main" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="target/scala-2.10/src_managed/test" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="target/scala-2.10/src_managed/test" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="target/scala-2.10/resource_managed/main" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="target/scala-2.10/resource_managed/main" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="target/scala-2.10/resource_managed/test" />))
    error("""Expected .classpath of root project to contain <classpathentry kind="src" path="target/scala-2.10/resource_managed/test" /> """)
...
TaskKey[Unit]("verify-classpath-xml-suba") <<= baseDirectory map { dir =>
  ...
  // src entries
  if (!(classpath.child contains <classpathentry kind="src" path="target/scala-2.10/resource_managed/main" />))
    error("""Expected .classpath of suba project to contain <classpathentry kind="src" path="target/scala-2.10/resource_managed/main" />: %s """ format classpath)
  if ((classpath.child contains <classpathentry kind="src" path="target/scala-2.10/resource_managed/test" />))
  ...
  if ((classpath.child contains <classpathentry kind="src" path="src/test/scala" />))
    error("""Not expected .classpath of root project to contain <classpathentry kind="src" path="src/test/scala" /> """)
  if ((classpath.child contains <classpathentry kind="src" path="src/test/java" />))
    error("""Not expected .classpath of root project to contain <classpathentry kind="src" path="src/test/java" /> """)
...
TaskKey[Unit]("verify-classpath-xml-subf") <<= baseDirectory map { dir =>
  val classpath = XML.loadFile(dir / "sub" / "subf" / ".classpath")
  if ((classpath \ "classpathentry") != (classpath \ "classpathentry").distinct)
    error("Expected .classpath of subf project not to contain duplicate entries: %s" format classpath)
  // src entries
  if (!(classpath.child contains <classpathentry kind="src" path="src/main/scala" />))
    error("""Expected .classpath of subf project to contain <classpathentry kind="src" path="src/main/scala" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/main/java" />))
    error("""Expected .classpath of subf project to contain <classpathentry kind="src" path="src/main/java" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/test/scala" />))
    error("""Expected .classpath of subf project to contain <classpathentry kind="src" path="src/test/scala" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/test/java" />))
    error("""Expected .classpath of subf project to contain <classpathentry kind="src" path="src/test/java" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/main/resources" />))
    error("""Expected .classpath of subf project to contain <classpathentry kind="src" path="src/main/resources" output="target/scala-2.10/classes" /> """)
  if (!(classpath.child contains <classpathentry kind="src" path="src/test/resources" />))
    error("""Expected .classpath of subf project to contain <classpathentry kind="src" path="src/test/resources" output="target/scala-2.10/test-classes" /> """)
  if ((classpath \ "classpathentry" \\ "@path") map (_.text) contains "target/scala-2.10/src_managed/main")
    error("""Not expected .classpath of subf project to contain <classpathentry kind="..." path="...src_managed/main" output="..." /> """)
  if ((classpath \ "classpathentry" \\ "@path") map (_.text) contains "target/scala-2.10/src_managed/test")
    error("""Not expected .classpath of subf project to contain <classpathentry kind="..." path="...src_managed/test" output="..." /> """)
  if ((classpath \ "classpathentry" \\ "@path") map (_.text) contains "target/scala-2.10/resource_managed/main")
    error("""Not expected .classpath of subf project to contain <classpathentry kind="..." path="...resource_managed/main" output="..." /> """)
  if ((classpath \ "classpathentry" \\ "@path") map (_.text) contains "target/scala-2.10/resource_managed/test")
    error("""Not expected .classpath of subf project to contain <classpathentry kind="..." path="...resource_managed/test" output="..." /> """)
  // other entries
  if ((classpath \ "classpathentry" \\ "@path") map (_.text) contains "scala-library.jar")
    error("""Not expected .classpath of subf project to contain <classpathentry path="...scala-library.jar" ... /> """)
  if ((classpath \ "classpathentry" \\ "@path") map (_.text) contains "scala-compiler.jar")
    error("""Not expected .classpath of subf project to contain <classpathentry path="...scala-compiler.jar" ... /> """)
  if (!(classpath.child contains <classpathentry kind="con" path="org.scala-ide.sdt.launching.SCALA_CONTAINER"/>))
    error("""Expected .classpath of subf project to contain <classpathentry kind="con" path="org.scala-ide.sdt.launching.SCALA_CONTAINER"/> """)
  if (!(classpath.child contains <classpathentry kind="con" path="org.scala-ide.sdt.launching.SCALA_COMPILER_CONTAINER"/>))
    error("""Expected .classpath of subf project to contain <classpathentry kind="con" path="org.scala-ide.sdt.launching.SCALA_COMPILER_CONTAINER"/> """)
  if (!(classpath.child contains <classpathentry kind="con" path="org.eclipse.jdt.launching.JRE_CONTAINER"/>))
    error("""Expected .classpath of subf project to contain <classpathentry kind="con" path="org.eclipse.jdt.launching.JRE_CONTAINER"/> """)
  if (!(classpath.child contains <classpathentry kind="output" path="bin"/>))
    error("""Expected .classpath of subf project to contain <classpathentry kind="output" path="bin"/> """)
}
